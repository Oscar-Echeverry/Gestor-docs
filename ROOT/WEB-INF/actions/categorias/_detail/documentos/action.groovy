...
class CrudAction_05iniz9dqrgc8z9jh29tvm1rg extends CrudAction {

    String linkToParentProperty = "categoria_id";
    String parentName = "categorias";
    ...
    protected void createSetup(Object object) {
        if(!StringUtils.isEmpty(parentName)) {
            object[linkToParentProperty] = ognlContext[parentName].id
        }
    }
